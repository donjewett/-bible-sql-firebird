...
-- Editions
----------------------------------------------------------------------------
COMMENT ON COLUMN Editions.Id IS 			'Auto-incrementing Id';
COMMENT ON COLUMN Editions.Code IS 			'Edition Code used for lookups. Must be unique';
COMMENT ON COLUMN Editions.VersionId IS 	'Version of the Edition';
COMMENT ON COLUMN Editions.YearPublished IS 'Year the Edition was first published in its entirety';
COMMENT ON COLUMN Editions.Subtitle IS 		'Subtitle for the Edition, esp. if different than Version (i.e. Second Edition)';
...
COMMENT ON COLUMN Resources.EditionId IS 		'Optional Edition of the Resource';
...
COMMENT ON COLUMN Bibles.EditionId IS 		'Optional Edition of this Bible';
COMMENT ON COLUMN Bibles.YearPublished IS 	'Year this Bible (or Edition) was published';
...
COMMENT ON COLUMN VersionNotes.EditionId IS 'Optional Edition for this Note -- for notes specific to an Edition';
